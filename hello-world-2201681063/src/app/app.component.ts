...
export class AppComponent {
  ...
  menuItems = [
    ...
    { title: 'Хобита и интереси', content: '12 часа от денят ми отиват в тежка гейминг сесия, а другите 4 си варя яйца.', isOpen: false },
    ...
    { title: 'Примерно остойностяване', content: 'Ако искате да колабваме или да работим заедно плащам единствено в exposure.', isOpen: false }
  ];
